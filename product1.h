...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void){
			...
			this->label4->Location = System::Drawing::Point(120, 94);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(659, 29);
			this->label4->TabIndex = 3;
			this->label4->Text = L"Введите название продукта и его калорийность (100 г.)";
			// 
			// textBox1
			// 
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Italic));
			this->textBox1->Location = System::Drawing::Point(81, 191);
			...
			this->textBox2->Location = System::Drawing::Point(666, 191);
			...
			this->button1->Location = System::Drawing::Point(344, 288);
			...
			this->ClientSize = System::Drawing::Size(941, 427);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (product == "" || kkal == "") {
			...
			while (dbReader->Read()) {
				...
				if (product_check == product) {
					MessageBox::Show("Продукт" + product + " уже есть в базе!", "", MessageBoxButtons::OK);
					fl = 1;
					dbReader->Close();
					dbConnection->Close();
					break;
		...
		if (fl == 0) {
			n++;
			String^ query1 = "INSERT INTO [Таблица1] (Продукт,калорийность )VALUES ('" + product + "' , '" + kkal + "')";
			OleDbCommand^ dbCommand1 = gcnew OleDbCommand(query1, dbConnection);
			dbCommand1->ExecuteNonQuery();
			MessageBox::Show("Новый продукт " + product + " добавлен!", "", MessageBoxButtons::OK);
			dbReader->Close();
			dbConnection->Close();
			this->Close();
		}
